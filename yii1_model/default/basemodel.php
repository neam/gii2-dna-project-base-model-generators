...
if (!empty($generator->baseClassTraits)) {
    echo "\n";
    foreach(explode(",", $generator->baseClassTraits) as $traitName) {
        echo '    use '.$traitName.';' . "\n";
    }
}
?>
...
?>
    ...
    /**
     * Item label logic is currently stored in the propel model query classes
     * @return string
     */
    ...
    /**
     * Returns the corresponding propel model class
     * @return string
     */
...
<?php
        foreach($labels as $name=>$label) {
            echo "            '$name' => Yii::t('".$messageCatalog."', '$label'),\n";
        }
?>
        );
    }
